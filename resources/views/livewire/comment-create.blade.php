            ...
            @if($saveSuccess)
                <div class="rounded-md bg-green-100 rounded-lg p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-green-800">Successfully Saved Comment</h3>
                            <div class="mt-2 text-sm text-green-700">
                                <p>Your new comment has been saved.</p>
                            </div>
                        </div>
                    </div>
                </div>
