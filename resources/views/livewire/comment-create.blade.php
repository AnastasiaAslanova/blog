<div>
    <div class="container mx-auto px-4">
        <h1 class="text-3xl mt-6 tracking-tight leading-10 font-extrabold text-gray-900 sm:leading-none">Add comment</h1>
        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
            ...
            <div class="sm:col-span-6 pt-5">
                ...
                <div class="mt-1">
                    <textarea id="body" rows="3" wire:model="comment" class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
                </div>
                <p class="mt-2 text-sm text-gray-500">Add the body for your comment.</p>
            </div>
